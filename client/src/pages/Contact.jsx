...
function Contact() {
  ...
  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "29ce0fce-125e-4cde-a03c-950bd35d7d87",
      name: data.username,
      email: data.email,
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-black text-white px-4 py-2 rounded-lg hover:bg-yellow-600 duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="w-full md:w-1/2 md:pl-4">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>free@patients.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaMapMarkerAlt className="text-green-500" />
                <span>Bhopal, Jhangirabad, India</span>
              </li>
            </ul>
          </div>
        </div>
